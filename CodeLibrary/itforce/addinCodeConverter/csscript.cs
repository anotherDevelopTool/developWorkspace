...
{
    //TODO 面向Addin基类化
    [AddinMeta(Name = "dataConvertTools", Date = "2019-10-14", Description = "代码变换工具", LargeIcon = "conversion")]
    public class ViewModel : DevelopWorkspace.Base.Model.ScriptBaseViewModel
    {
        UserControl view;
        ReoGridControl reogrid = null;
        ICSharpCodeX.AvalonEdit.Edi.EdiTextEditor convertRule;
                ...
                if ("yes".Equals(tableInfo["SQL file create"]))
                {
                    ...
                    foreach (var sqlKey in sqlKeys)
                    {
                        ...
                        if (sqloutput)
                        {
                            ...
                            DevelopWorkspace.Base.Logger.WriteLine("templatekey:" + templatekey,Level.DEBUG);
        ...
        public void EventHandler4(object sender, RoutedEventArgs e)
        {
            ...
            DevelopWorkspace.Base.Logger.WriteLine("Process called",Level.DEBUG);
        }
        ...
        public void EventHandler16(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (selectedClazz != null)
                {
                    ...
                    StringWriter vltWriter = new StringWriter();
                    DevelopWorkspace.Base.Logger.WriteLine(selectedClazz.filePath,Level.DEBUG);
                    DevelopWorkspace.Base.Logger.WriteLine(selectedClazz.packageName,Level.DEBUG);
                    DevelopWorkspace.Base.Logger.WriteLine(selectedClazz.clazzName,Level.DEBUG);
        ...
        public override UserControl getView(string strXaml)
        {
            ...
            convertRule = DevelopWorkspace.Base.Utils.WPF.FindLogicaChild<ICSharpCodeX.AvalonEdit.Edi.EdiTextEditor>(view, "convertRule");
...
//            System.Diagnostics.Debugger.Break();
            ...
            for (int idex = 1; idex < 50; idex++)
            {
                ...
                DevelopWorkspace.Base.Logger.WriteLine("excludeProjectName:" + excludeProjectName,Level.DEBUG);
            }
            //package mapping
            ...
            for (int idex = 1; idex < 50; idex++)
            {
                ...
                DevelopWorkspace.Base.Logger.WriteLine("packageName:" + projectName,Level.DEBUG);
            }
