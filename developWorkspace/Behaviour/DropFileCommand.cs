...
using System.Linq;
namespace DevelopWorkspace.Main.Behaviour
{
    ...
    /// <summary>
    /// Source:
    /// 1.添加属性添加到具体控件上后2.激活OnDropCommandChange再关联控件的Drop事件和设置的COMMAND进行关联
    /// 当然这之前需要设置的COMMAND和具体动作进行绑定
    /// 这里的示例为MainWindow.xaml的behav:DropFileCommand.DropCommand="comm:AppCommand.LoadFile"
