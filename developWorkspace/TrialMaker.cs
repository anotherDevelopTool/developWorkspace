...
namespace SoftwareLocker
{
    ...
    public class TrialMaker
    {
        ...
        public RunTypes ShowDialog()
        {
            ...
            MakeHideFile();
            //
            if (_DefDays < 30 || _Runed < 30)
            {
                System.Windows.Forms.Application.EnableVisualStyles();
                System.Windows.Forms.Application.SetCompatibleTextRenderingDefault(false);
                //WindowInteropHelper wih = new WindowInteropHelper(System.Windows.Application.Current.MainWindow);
                //wih.Owner = PassDialog.Handle;


                DialogResult DR = PassDialog.ShowDialog(new WpfWindowWrapper(System.Windows.Application.Current.MainWindow));
