namespace ICSharpCodeX.AvalonEdit.BracketRenderer
{
  ...
  public class EdiBracketSearcher : IBracketSearcher
  {
    ...
    private static int ScanLineStart(ICSharpCodeX.AvalonEdit.Document.TextDocument document, int offset)
    {
    ...
    /// </summary>
    private static int GetStartType(ICSharpCodeX.AvalonEdit.Document.TextDocument document, int linestart, int offset)
    {
      bool inString = false;
      bool inChar = false;
      bool verbatim = false;
    ...
    private int SearchBracketBackward(ICSharpCodeX.AvalonEdit.Document.TextDocument document, int offset, char openBracket, char closingBracket)
    {
    ...
    private  int SearchBracketForward(ICSharpCodeX.AvalonEdit.Document.TextDocument document, int offset, char openBracket, char closingBracket)
    {
      bool inString = false;
      bool inChar = false;
      bool verbatim = false;
    ...
    private int QuickSearchBracketBackward(ICSharpCodeX.AvalonEdit.Document.TextDocument document, int offset, char openBracket, char closingBracket)
    {
      int brackets = -1;
      // first try "quick find" - find the matching bracket if there is no string/comment in the way
    ...
    private int QuickSearchBracketForward(ICSharpCodeX.AvalonEdit.Document.TextDocument document, int offset, char openBracket, char closingBracket)
    {
      int brackets = 1;
