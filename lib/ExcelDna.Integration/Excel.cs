...
namespace ExcelDna.Integration
{
    public class ExcelDnaUtil
    {
        ...
        public static void Initialize(int processId,int threadId)
        {
            // NOTE: Sequence here is important - Getting the Window Handle sometimes uses the _mainNativeThreadId
            _mainManagedThreadId = processId;//Thread.CurrentThread.ManagedThreadId;
            _mainNativeThreadId = (uint)threadId;//GetCurrentThreadId();
